...
export default function ChatSessionsList({ sessions, currentId, onSelect, onNew, sending }) {
  return (
    <div className="p-6 bg-white rounded-lg shadow-md h-full flex flex-col border border-gray-200"> 
      <h2 className="text-xl font-semibold mb-4 text-teal-700">Your Chats</h2> 
      <button
        onClick={onNew}
      ...
      {sessions.length === 0 ? (
        ...
        <ul className="overflow-y-auto flex-1 -mr-2 pr-2 custom-scrollbar">
